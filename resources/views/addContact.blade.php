        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form id="myForm" action="{{ route('contacts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf            
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="branch_code" id="branch_code" autocomplete="branch_code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="empid" id="empid" autocomplete="empid" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="designation" id="designation" autocomplete="designation" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="mobile_number" id="mobile_number" autocomplete="mobile_number" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="telephone_number" id="telephone_number" autocomplete="telephone_number" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
